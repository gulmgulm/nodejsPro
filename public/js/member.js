...
$(document).ready(function(){
    ...
    $ag.click(function(){
        if($ag.is(":checked")){
            alert("感谢您的理解，请继续注册！");
            $regsub.css("display","block");
        }else{
            alert("由于您没有同意我们的服务协议，您将不能注册！");
            $regsub.css("display","none");
        }
    })
})
$(function(){
...
{
    $("#J_ajaxForm").attr("action", url).submit();
}